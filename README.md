...
2. 评论回复通知被回复评论的用户
3. 评论审核通知通知发布评论的用户
4. 可开启文章发布通知，将新文章发送给指定邮箱列表
5. 可额外开启文章更新通知，已发布文章更新时也会发送邮件

文章通知使用主题选项里的 SMTP 配置发送。若使用学校邮箱作为发件邮箱，请在 SMTP 邮件账号中填写 `12211612@mail.sustech.edu.cn`，并配置学校邮箱对应的 SMTP 服务器、端口、协议和授权密码。收件人支持一行一个邮箱，也支持用逗号或分号分隔。默认只发送新文章通知，文章更新通知需要单独开启。
