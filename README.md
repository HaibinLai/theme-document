...
**当前版本：** 1.7.1 &nbsp;|&nbsp; **许可证：** GPL v2+ &nbsp;|&nbsp; **原作者：** [友人a丶](https://nicen.cn/) &nbsp;|&nbsp; **当前维护者：** Haibin
...
- 邮箱订阅审核：读者提交订阅申请后，站长在后台批准后才会收到文章通知
...
文章通知使用主题选项里的 SMTP 配置发送。若使用学校邮箱作为发件邮箱，请在 SMTP 邮件账号中填写 `12211612@mail.sustech.edu.cn`，并配置学校邮箱对应的 SMTP 服务器、端口、协议和授权密码。收件人支持一行一个邮箱，也支持用逗号或分号分隔。默认关闭文章通知；如果希望更新旧文章也提醒读者，可以在下拉框中选择“发布新文章和更新文章”。

开启“显示读者邮箱订阅入口”后，文章底部会出现订阅表单。读者提交后不会立刻收到邮件，而是进入后台【邮件订阅】待审核列表；批准后才会并入文章通知收件人。后台可对申请执行批准、拒绝和删除操作。
